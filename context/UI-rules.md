Use and install the below for making any UI components or sections
Strictly use these unless specified to use something else

Shadcn skills added  pnpm dlx skills add shadcn/ui

use this sidebar only npx shadcn@latest add sidebar-07 (added)
